...
Vec3	Vec3TransformDirection(const Vec3& v, const Matrix& m);																																													// 3D-Richtungsvektor mit Matrix multiplizieren
/*Vec3	Vec3TransformNormal(const Vec3& v, const Matrix& m);																																														// 3D-Normalenvektor mit Matrix multiplizieren
Vec3	Vec3TransformNormal_TranspInv(const Vec3& v, const Matrix& m);																																												// 3D-Normalenvektor mit Matrix multiplizieren
*/
